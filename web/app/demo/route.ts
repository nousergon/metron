...
// `/demo` — open the read-only Reference Rate showcase with no signup. Sets the demo
...
// Was its own separate frozen "Demo portfolio" fixture; merged into Reference Rate to
// cut showcase-portfolio clutter (see api/services/demo.py module docstring).
