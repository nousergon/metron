...
STATEMENT = """<FlexQueryResponse queryName="All" type="AF">
  <FlexStatements count="1">
    <FlexStatement accountId="U24215043" fromDate="20250606" toDate="20260605">
      <AccountInformation accountId="U24215043" acctAlias="Growth" accountType="Individual" currency="USD"/>
      <EquitySummaryInBase>
        <EquitySummaryByReportDateInBase accountId="U24215043" reportDate="20260604" cash="500" total="9500" currency="BASE"/>
        <EquitySummaryByReportDateInBase accountId="U24215043" reportDate="20260605" cash="600" total="10000" currency="BASE"/>
      </EquitySummaryInBase>
      <OpenPositions>
        <OpenPosition accountId="U24215043" symbol="RKLB" assetCategory="STK" position="100" markPrice="30" positionValue="3000" costBasisPrice="20" costBasisMoney="2000" currency="USD"/>
        <OpenPosition accountId="U24215043" symbol="SPY" assetCategory="ETF" position="10" markPrice="500" positionValue="5000" costBasisPrice="450" costBasisMoney="4500" currency="USD"/>
        <OpenPosition accountId="U24215043" symbol="AAPL  250620C" assetCategory="OPT" position="1" markPrice="5" positionValue="500" costBasisPrice="3" costBasisMoney="300" currency="USD"/>
        <OpenPosition accountId="U24215043" symbol="" assetCategory="CASH" position="600" markPrice="1" currency="USD"/>
      </OpenPositions>
      <CashTransactions>
        <CashTransaction accountId="U24215043" symbol="RKLB" type="Dividends" amount="50" currency="USD" dateTime="20260301"/>
        <CashTransaction accountId="U24215043" symbol="" type="Broker Interest Received" amount="12.34" currency="USD" dateTime="20260401"/>
        <CashTransaction accountId="U24215043" symbol="" type="Broker Interest Paid" amount="-3.00" currency="USD" dateTime="20260401"/>
        <CashTransaction accountId="U24215043" symbol="RKLB" type="Withholding Tax" amount="-7.50" currency="USD" dateTime="20260301"/>
      </CashTransactions>
      <Trades>
        <Trade accountId="U24215043" symbol="MSFT" assetCategory="STK" tradeDate="20260115" dateTime="20260115;153000" quantity="-10" proceeds="2000" cost="-1505" fifoPnlRealized="495" openDateTime="20240601;100000" buySell="SELL" levelOfDetail="CLOSED_LOT"/>
      </Trades>
    </FlexStatement>
  </FlexStatements>
</FlexQueryResponse>"""
...
def test_connector_full_snapshot(tmp_path, monkeypatch):
    ...
    assert snap.accounts[0].account_id == "U24215043"  # Flex: number is the id
